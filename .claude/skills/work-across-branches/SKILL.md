...
description: How concurrent branches are handled in this repository — rebase onto origin/main rather than merging, which three documentation files actually collide and how each resolves, minting a decision identifier, and why a clean rebase is not evidence. Use when rebasing, resolving a conflict, sequencing two open branches, or adding an entry to decisions.md or project-history.md.
---
