...
- **The home hero's career-transition line is `lg` (18px).** It sits between the name and the animated role, which uses the `h4` heading token (20px); all three lines use the shared type scale.
