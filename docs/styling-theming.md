...
- **The home hero's career-transition line is `lg` (18px).** It sits beneath the animated role, which uses the `h4` heading token (20px), preserving a small but clear hierarchy while keeping both values on the shared type scale.
