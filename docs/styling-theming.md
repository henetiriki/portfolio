...
**Generation is skipped where `VERCEL` is set**, so a deployed build has no copy of this file; `css-vars:check` is unaffected and runs in any environment. See [the decision](decisions/2026-09-07-skip-the-webstorm-css-stub-on-vercel.md).
