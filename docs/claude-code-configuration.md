...
Both are moved out of the way for now — the configuration, rules, skills and agents built up here had made the project unmanageable and expensive to change. They will be re-added, deliberately smaller, later. This page will describe them again once that happens.
